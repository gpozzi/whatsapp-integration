...
# ⚡ Performance: Executor global para tareas asíncronas y concurrencia optimista
...
def process_message(user_text: str, phone_number: str, message_id: Optional[str] = None, image_data: Optional[bytes] = None, audio_data: Optional[bytes] = None) -> Union[str, bytes, None]:
    ...
    # 2. Análisis de Intención y Tono (OPTIMISTA: En paralelo con búsqueda)
    # ⚡ Performance: Ejecutamos análisis de intención y búsqueda vectorial concurrentemente
